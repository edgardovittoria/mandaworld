    ...
    <div className="hidden xl:flex xl:flex-row xl:items-center xl:gap-10 xl:relative xl:z-20">
      ...
      >
        <div className="h-[30px] flex flex-col items-center">
          ...
          {selectedItem === "Home" && (
            <Image src="/disco.gif" alt="alt" width={50} height={50} unoptimized />
          )}
        </div>
      </Link>
      ...
      <Link
        href="/#eventi"
        className="flex flex-col items-center hover:cursor-pointer hover:opacity-60"
        onClick={() => setSelectedItem("Eventi")}
      >
        <div className="h-[30px] flex flex-col items-center">
      ...
      <Link
        href="/#piscina"
        className="flex flex-col items-center hover:cursor-pointer hover:opacity-60"
        onClick={() => setSelectedItem("Piscina")}
      >
        <div className="h-[30px] flex flex-col items-center">
      ...
      <Link
        href="/#contatti"
        className="flex flex-col items-center hover:cursor-pointer hover:opacity-60"
        onClick={() => setSelectedItem("Contatti")}
      >
        <div className="h-[30px] flex flex-col items-center">
      ...
      {session && (
        ...
        >
          <div className="h-[30px] flex flex-col items-center">
            <span className="uppercase text-white text-2xl mandaFont">Admin</span>
            {selectedItem === "Admin" && (
              <Image src="/disco.gif" alt="alt" width={50} height={50} />
            )}
          </div>
