  ...
  return (
    <div id="contatti" className="w-full py-20">
      <div className="flex flex-col  items-center gap-8">
        ...
        <Link href="tel:+390872220607" className="rounded-full mb-20 xl:mb-0 flex items-center justify-center flex-row gap-4 md:w-1/3 w-2/3 lg:py-3 py-2 border-[2px] border-secondary text-secondary lg:text-2xl text-xl mt-10 lg:mt-20 hover:bg-secondary hover:text-backgroundColor hover:cursor-pointer">
